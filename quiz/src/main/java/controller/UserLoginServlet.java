        ...
        try (Connection con = DBConnection.getConnection()) {
            if (action.equals("Register")) {
                ...
                if (rs.next()) {
                	...
                	response.sendRedirect(request.getContextPath() + "/user.jsp?msg=User already exists, please login.");
                } else {
                    // register user
                    ...
                    response.sendRedirect(request.getContextPath() + "/user.jsp?msg=Registered successfully! You can login now.");
                }
